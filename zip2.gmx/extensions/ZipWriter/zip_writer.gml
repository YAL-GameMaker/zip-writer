...
/// @function zip_impl_crc32(buf:buffer, pos:int, len:int)->int
/// @param buf:buffer
/// @param pos:int
/// @param len:int
...
/// @function zip_impl_write(dst:buffer, src:buffer, srcPos:int, srcLen:int)
/// @param dst:buffer
/// @param src:buffer
/// @param srcPos:int
/// @param srcLen:int
...
#define zip_create
/// @function zip_create(compressionLevel:int = -1)
...
/// @function zip_add_buffer_ext(this:zip, path:string, buf:buffer, pos:int, len:int)
/// @param this:zip
/// @param path:string
/// @param buf:buffer
/// @param pos:int
...
/// @function zip_add_buffer(this:zip, path:string, buf:buffer)
/// @param this:zip
/// @param path:string
/// @param buf:buffer
...
#define zip_add_file
/// @function zip_add_file(this:zip, path:string, filePath:string)
/// @param this:zip
/// @param path:string
...
#define zip_finalize
/// @function zip_finalize(this:zip)
/// @param this:zip
var this = argument[0];
this[@2/* open */] = false;
var o = this[0/* buffer */];
...
#define zip_save
/// @function zip_save(this:zip, path:string)
/// @param this:zip
/// @param path:string
...
/// @function zip_get_buffer(this:zip)->buffer
/// @param this:zip
var this = argument[0];
if (this[2/* open */]) zip_finalize(this);
