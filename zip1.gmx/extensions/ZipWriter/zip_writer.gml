...
/// zip_add_buffer_ext(this:zip, path:string, buf:buffer, pos:int, len:int)
...
var clen = len;
if (compress) {
	cbuf = buffer_deflate(buf, pos, len, this[3/* compression_level */]);
	clen = buffer_tell(cbuf) - 6;
}
